...
**|        GroupId        |    Name     |          VpcId          |**
**+-----------------------+-------------+-------------------------+**
**|  sg-0f932af801e33d267 |  ec2-lab-sg |  vpc-0f788f9702ce28e45  |**
**|  sg-001b40d6a6334fb9d |  rds-lab-sg |  vpc-0f788f9702ce28e45  |**
**|  sg-0cae4aac806c111f9 |  default    |  vpc-0f08193db2f851cd5  |**
**|  sg-0f2c53bbc7f7c828e |  default    |  vpc-0f788f9702ce28e45  |**
**+-----------------------+-------------+-------------------------+**
...
Inspect a specific security group (inbound & outbound rules)
    ...
    aws ec2 describe-security-groups \
  --region ap-northeast-1 \
  --group-ids sg-0f932af801e33d267 \
  --output json
**{**
    **"SecurityGroups": [**
        **{**
            ...
            **"SecurityGroupArn": "arn:aws:ec2:ap-northeast-1:557690581423:security-group/sg-0f932af801e33d267",**
...
EC2 instances
    ...
    aws ec2 describe-security-groups \
  --region ap-northeast-1 \
  --group-ids sg-0f932af801e33d267 sg-001b40d6a6334fb9d \
...
**|          GroupId          |     Name       |**
**+---------------------------+----------------+**
**|  sg-001b40d6a6334fb9d     |  rds-lab-sg    |**
**+---------------------------+----------------+**
**||                  Ingress                 ||**
**|+-------------+----------------+-----------+|**
...
**|          GroupId          |     Name       |**
**+---------------------------+----------------+**
**|  sg-0f932af801e33d267     |  ec2-lab-sg    |**
**+---------------------------+----------------+**
**||                  Ingress                 ||**
**|+-------------+----------------+-----------+|**
**||  FromPort   |  IpProtocol    |  ToPort   ||**
